...
exports.run = run;
if (!module.parent) {
    const downloadUrl = utils_1.getOptionalString('downloadUrl', DOWNLOAD_URL);
    ...
    run(downloadUrl, EXECUTABLE, coverageCommand, codeClimateDebug, coverageLocations, coveragePrefix);
}
